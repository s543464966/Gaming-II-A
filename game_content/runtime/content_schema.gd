...
const FILES = {
	...
	"Combat/growth_rules.csv": ["growth_rules", "id,chapter_level_bonus_ratio,training_step_bonus_ratio,star_stone_step_costs,training_step_count,star_stat_multipliers,hero_damage_bonus_ratio_per_star"],
	...
	"Progression/aurora_reward_rules.csv": ["aurora_reward_rules", "id,max_triggers,offer_count"],
	"Progression/black_market_rules.csv": ["black_market_rules", "id,fragment_offer_count,fragment_amount,minion_weight,item_weight,hero_weight,gold_to_star_cost,gold_to_star_reward,star_to_gold_cost,star_to_gold_reward,stamina_small_amount,stamina_small_gold_price,stamina_small_star_stone_price,stamina_large_amount,stamina_large_gold_price,stamina_large_star_stone_price"],
	"Progression/adventure_encounter_rules.csv": ["adventure_encounter_rules", "id,refresh_count,dice_reward_weight,star_stone_reward_weight,relic_reward_weight,card_reward_weight,star_stone_min,star_stone_max,card_minion_weight,card_item_weight,stamina_cost_weight,team_debuff_cost_weight,card_cost_weight,die_cost_weight,stamina_cost_amount,team_debuff_amount"],
	...
	"Progression/chapters.csv": ["chapters", "id,sort_order,chapter_index,difficulty,monster_set_id,name,flavor_text,stamina_cost,unlocked_background_key,locked_background_key,route_music_key,battle_music_key,enemy_health_multiplier,enemy_power_multiplier,elite_guard_health_multiplier,boss_guard_health_multiplier"],
...
const JSON_FIELDS = ["actions", "ability_parts", "innate_ability_ids", "card_tag_ids", "synergy_ids", "activation_conditions", "applies_to_kinds", "required_outputs", "star_stone_step_costs", "star_stat_multipliers"]
const INTEGERS = ["physical_damage", "witchcraft_damage", "burn_damage", "poison_damage", "healing_power", "shield_power", "max_health", "training_step_count", "priority", "footprint_width", "footprint_height", "member_index", "chapter_index", "section_index", "layer_index", "normal_monster_count", "stamina_cost", "normal_battle_count", "elite_battle_count", "relic_count", "black_market_count", "adventure_count", "cost_amount", "reward_amount", "max_stack", "selection_weight", "sort_order", "fragment_amount", "purchase_limit", "payable_percent", "account_gold_price", "account_star_stone_price", "ammo_capacity", "multicast_count", "initially_unlocked", "normal_dice_count", "elite_dice_count", "elite_treasure_dice_count", "boss_dice_count", "rerolls_per_node", "choice_count", "choice_seconds", "refreshes_per_choice", "amount_min", "amount_max", "amount_step", "distinct_count", "max_triggers", "offer_count", "fragment_offer_count", "minion_weight", "item_weight", "hero_weight", "gold_to_star_cost", "gold_to_star_reward", "star_to_gold_cost", "star_to_gold_reward", "stamina_small_amount", "stamina_small_gold_price", "stamina_small_star_stone_price", "stamina_large_amount", "stamina_large_gold_price", "stamina_large_star_stone_price", "refresh_count", "dice_reward_weight", "star_stone_reward_weight", "relic_reward_weight", "card_reward_weight", "star_stone_min", "star_stone_max", "card_minion_weight", "card_item_weight", "stamina_cost_weight", "team_debuff_cost_weight", "card_cost_weight", "die_cost_weight", "stamina_cost_amount", "team_debuff_amount"]
const FLOATS = ["cooldown_seconds", "enemy_health_multiplier", "enemy_power_multiplier", "elite_guard_health_multiplier", "boss_guard_health_multiplier", "crit_chance", "crit_multiplier", "haste_ratio", "lifesteal_ratio", "chapter_level_bonus_ratio", "training_step_bonus_ratio", "hero_damage_bonus_ratio_per_star"]
